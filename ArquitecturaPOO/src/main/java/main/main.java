...
import obejcts.Cine;
import obejcts.Espectador;
import obejcts.Metodos;
import obejcts.Pelicula;
...
public class main {
    ...
    public static void main(String[] args) {
        ...
        //Creo la pelicula
        Pelicula pelicula = new Pelicula("Mi vida", 90, 16, "Grupo3");
        ...
        for (int i = 0; i < numEspectadores && cine.haySitio(); i++) {
            ...
            e = new Espectador(
                    ...
                    Metodos.generaNumeroEnteroAleatorio(8, 15)); //Generamos el dinero entre 1 y 10 euros
